  ...
  <div>
    <div class="public-table-header">
      <div>
        ...
        <el-button id="cruise_warehouse" @click="initTableList" size="mini" :icon="table.inSelect? 'el-icon-refresh' :'el-icon-search'"
  ...
  export default {
    ...
    data() {
      return {
        ...
        reason: {
          warehouseTypeId: this.cruise.id,
          name: ''
        },
        table: {
          list: [],
