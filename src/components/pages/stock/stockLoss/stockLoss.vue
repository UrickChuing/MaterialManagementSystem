  ...
  <div @keydown.enter="initTableList" v-if="otherPage.PAGE == 'INDEX'">
    ...
    <div class="public-table-header">
      <el-button @click="otherPage.PAGE = 'DETAILS';otherPage.status.details = STATUS.ADD" type="primary" size="mini">报损</el-button>
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="代码" prop="code" align="center" min-width="200">
        <template slot-scope="scope">
          <i-label :target="scope.row" :type="AuditType.value.STOCK_LOSS" :info="false" key></i-label>
        </template>
      </el-table-column>
      <el-table-column label="品项数" prop="itemNumber" align="center" min-width="180">
      </el-table-column>
      <el-table-column label="说明" prop="description" align="center" min-width="180">
      </el-table-column>
...
<script>
  import rDetails from './stockLoss_details.vue';
