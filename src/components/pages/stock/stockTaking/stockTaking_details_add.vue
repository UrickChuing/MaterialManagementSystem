...
<!--          <el-table-column label="采购订单" prop="code" align="center" min-width="180">
          ...
          <el-table-column label="批次号" prop="stockInCode" align="center" min-width="120">
          </el-table-column>
          ...
          <el-table-column label="可用库存(库存)" prop="applicantName" align="center" min-width="130">
            <template slot-scope="scope">
              {{ scope.row.remainNumber }} ({{scope.row.beforeNumber}})
            </template>
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/stock/taking/add/materials/list',
          data: {
            reason: that.reason,
          ...
          for (var itemIndex in items) {
            ...
            itemDemo.afterNumber = itemDemo.beforeNumber + 0;
            itemDemo.add = false;
