...
<!--          <el-table-column label="采购订单" prop="code" align="center" min-width="180">
          ...
          <el-table-column label="批次号" prop="code" align="center" min-width="150">
          </el-table-column>
          <el-table-column label="物品编码" align="center" min-width="190">
          ...
          <el-table-column label="可用库存(实际库存)" prop="applicantName" align="center" min-width="120">
            <template slot-scope="scope">
              {{ scope.row.remainNumber }} ({{scope.row.actNumber}})
            </template>
          </el-table-column>
  ...
  export default {
    data() {
      ...
      return {
        ...
        reason: {
          ...
          warehouseId: parent.bean.warehouseId
        },
    ...
    methods: {
      ...
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/stock/allocation/add/materials',
          data: {
            reason: that.reason,
