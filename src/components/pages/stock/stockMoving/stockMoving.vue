<template>
  <div @keydown.enter="initTableList" v-if="otherPage.PAGE == 'INDEX'">
    ...
    <div class="public-table-header">
      <el-button @click="otherPage.PAGE = 'DETAILS';otherPage.status = STATUS.ADD" type="primary" size="mini">调配</el-button>
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      <el-table-column label="单号" prop="code" align="center" min-width="200">
        <template slot-scope="scope">
          <i-label :target="scope.row" :type="AuditType.value.MATERIAL_MOVE" :info="false" key></i-label>
        </template>
      </el-table-column>
      <el-table-column label="条数" prop="itemNumber" align="center" min-width="50">
      </el-table-column>
...
<script>
  import sDetails from './stockMoving_details.vue';
