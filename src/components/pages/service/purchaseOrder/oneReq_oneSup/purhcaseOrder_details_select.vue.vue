<template>
  <div class="select-delivery-request">
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="单号" prop="code" align="center" min-width="180">
      </el-table-column>
      ...
      <el-table-column label="创建人(部门)" prop="organizationId" align="center" min-width="180">
        <template slot-scope="scope">
          {{scope.row.createUserName}} ( {{scope.row.organizationName}} )
        </template>
      </el-table-column>
      <el-table-column fixed="right" label="操作" prop="applicationNo" align="center" width="100">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/purchaseOrder/options/purchase/request',
          data: {
