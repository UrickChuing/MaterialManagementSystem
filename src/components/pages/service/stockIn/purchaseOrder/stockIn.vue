    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      <el-table-column label="单号" prop="code" align="center" min-width="200">
        <template slot-scope="scope">
          <i-label :target="scope.row" :type="AuditType.value.STOCKIN_PURCHASE" :info="false" key></i-label>
        </template>
      </el-table-column>
...
<script>
  import sDetails from './purchaseOrder_details.vue';
