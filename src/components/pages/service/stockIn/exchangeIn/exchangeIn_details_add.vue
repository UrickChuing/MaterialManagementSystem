...
<!--          <el-table-column label="采购订单" prop="code" align="center" min-width="180">
          ...
          <el-table-column label="条形码" prop="materialBarCode" align="center" min-width="120">
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/exchange/in/add/materials/list',
          data: {
            reason: that.reason,
          ...
          for (var itemIndex in items) {
            ...
            itemDemo.number = itemDemo.remainNumberIn + 0;
            itemDemo.add = false;
