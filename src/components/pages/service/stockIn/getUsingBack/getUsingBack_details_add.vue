...
<!--          <el-table-column label="采购订单" prop="code" align="center" min-width="180">
          ...
          <el-table-column label="批次号" prop="stockInCode" align="center" min-width="150">
          </el-table-column>
          ...
          <el-table-column label="物品名称" prop="materialName" align="center" min-width="120">
          </el-table-column>
          <el-table-column label="条形码" prop="barCode" align="center" min-width="120">
          </el-table-column>
          ...
          <el-table-column label="原仓库" prop="warehouseName" align="center" min-width="210">
          </el-table-column>
          <el-table-column label="可入库" prop="applicantName" align="center" min-width="120">
            <template slot-scope="scope">
  ...
  export default {
    data() {
      ...
      return {
        ...
        reason: {
          ...
          deliveryVoucherId: parent.bean.deliveryVoucherId
        },
    ...
    methods: {
      ...
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/stock/in/getBack/add/materials/list',
          data: {
            reason: that.reason,
