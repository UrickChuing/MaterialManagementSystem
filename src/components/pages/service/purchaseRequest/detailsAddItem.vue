			...
			<div class="public-scroll-y-hide" style="height: calc(100% - 41px);">
				...
				<el-table :data="table.list" style="width: 100%;margin-top: 20px;border-top: 1px solid #EBEEF5;" max-height="490px"
				 cell-class-name="public-table-cell">
					...
					<el-table-column label="部门库存" prop="applicantName" align="center" min-width="120">
						<template slot-scope="scope">
							{{ scope.row.availOStock + '(' + scope.row.totalOStock + ')'   }}
						</template>
					</el-table-column>
	...
	export default {
		data() {
			...
			return {
				...
				reason: {
					...
					oStock_organizationId: parent.userInfo.organizationId,
		...
		methods: {
			...
			initTableList: function() {
				...
				axios({
					method: 'post',
					url: '/purchaseRequest/add/material/list',
					data: {
						reason: that.reason,
