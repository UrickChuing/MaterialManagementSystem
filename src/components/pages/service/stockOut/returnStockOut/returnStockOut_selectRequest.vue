<template>
  <div class="select-delivery-request">
    ...
    <div class="public-table-header">
      ...
      <el-input v-model="reason.code" placeholder="退货单号" size="mini" style="width: 180px;"></el-input>
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="退货单号" prop="code" align="center" min-width="220">
      </el-table-column>
<!--      <el-table-column label="品项" prop="itemNumber" align="center" min-width="180">
      </el-table-column> -->
      <el-table-column label="说明" prop="code" align="center" min-width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="退货提交时间" prop="createTime" align="center" min-width="180">
        <template slot-scope="scope">
      ...
      <el-table-column fixed="right" label="操作" prop="applicationNo" align="center" width="300">
        <template slot-scope="scope">
          <el-button @click="selectTarget(scope.row)" :type="id == scope.row.id? 'success':'primary'" size="mini">{{id == scope.row.id? '已选择':'选择'}}</el-button>
          <!-- 未提交 -->
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/delivery/voucher/return/options/delivery/request',
          data: {
            reason: that.reason,
