  ...
  <div>
    ...
    <div class="input-line">
      ...
      <!--      <div class="input-block" v-if="operation == STATUS.ADD">
        <span></span>
        <el-select v-model="bean.warehouseVoucherId" title="请选择入库单" placeholder="请选择供应商">
          <el-option v-for="item in options.warehouseVoucher" :key="item.id" :label="item.code" :value="item.id">
          </el-option>
        </el-select>
      </div> -->
    ...
    <div class="public-table-header">
      ...
      <div class="upload-button-div pointer" @click="uploadClick" v-if="false">
    ...
    <el-dialog :custom-class="['dialog-card','self-card']" :visible.sync="inAdd" :append-to-body="true">
      ...
      <audit-process @set="setPorcess" :processId="bean.auditProcessId" :auditProcess="bean.auditProcess" :type="AuditType.value.DELIVERY_REQUEST"
...
<script>
  import addItem from './returnRequest_details_add.vue';
  import wvSelect from './returnRequest_warehouseVoucer.vue';
    ...
    methods: {
      ...
      initOptions: function(callBack) {
        ...
        axios({
          ...
          that.options.warehouseVoucher = data.data.warehouseVoucher;
