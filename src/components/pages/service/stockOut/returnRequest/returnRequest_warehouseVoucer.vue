<template>
  <div class="select-delivery-request">
    ...
    <div class="public-table-header">
      ...
      <el-input v-model="reason.code" placeholder="入库单号" size="mini" style="width: 180px;"></el-input>
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="入库单号" prop="code" align="center" min-width="210">
      </el-table-column>
      ...
      <el-table-column label="入库提交时间" prop="createTime" align="center" min-width="180">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/delivery/request/options/warehouse/voucher',
          data: {
            reason: that.reason,
