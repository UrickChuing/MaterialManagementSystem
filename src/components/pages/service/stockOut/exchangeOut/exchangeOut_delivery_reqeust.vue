<template>
  <div class="select-delivery-request">
    ...
    <div class="public-table-header">
      ...
      <el-input v-model="reason.code" placeholder="换货申请单号" size="mini" style="width: 180px;"></el-input>
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="代码" prop="code" align="center" min-width="220">
      </el-table-column>
      ...
      <el-table-column label="入库单号(换货)" prop="warehouseVoucherCode" align="center" min-width="220">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/exchange/out/delivery/request',
          data: {
