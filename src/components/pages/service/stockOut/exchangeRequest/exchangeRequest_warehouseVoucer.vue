<template>
  <div class="select-delivery-request">
    ...
    <el-table :data="table.list" style="width: 100%" cell-class-name="public-table-cell">
      ...
      <el-table-column label="入库单号" prop="code" align="center" min-width="190">
      </el-table-column>
      <el-table-column label="品项" prop="itemNumber" align="center" min-width="80">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/exchange/request/options/warehouse/voucher',
          data: {
            reason: that.reason
          },
          df: false
