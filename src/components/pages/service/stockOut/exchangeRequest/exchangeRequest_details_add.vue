    ...
    <div>
      ...
      <div class="public-scroll-y-hide" style="height: calc(100% - 41px);">
        ...
        <el-table :data="table.list" style="width: 100%;margin-top: 20px;border-top: 1px solid #EBEEF5;" max-height="490px"
          ...
          <el-table-column label="物品" prop="code" align="center" min-width="200">
...
<!--          <el-table-column label="供应商" prop="supplierName" align="center" min-width="160">
          </el-table-column>
          <el-table-column label="协议" prop="supplierAgreementName" align="center" min-width="120">
          </el-table-column> -->
          ...
          <el-table-column label="可用库存(实际库存)" align="center" min-width="120">
            <template slot-scope="scope">
  ...
  export default {
    data() {
      ...
      return {
        ...
        reason: {
          ...
          warehouseVoucherId: parent.bean.warehouseVoucherId,
        },
    ...
    methods: {
      ...
      initTableList: function() {
        ...
        axios({
          method: 'post',
          url: '/exchange/request/add/materials',
          data: {
            reason: that.reason,
