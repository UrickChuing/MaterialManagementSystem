<template>
  <div>
    ...
    <el-table :data="table.list" style="width: 100%;border-top: 1px solid #EBEEF5;" max-height="490px" cell-class-name="public-table-cell">
      ...
      <el-table-column label="领用量" prop="number" align="center" min-width="150">
      </el-table-column>
      <el-table-column label="领用次数" prop="totalCount" align="center" min-width="150">
      </el-table-column>
    </el-table>
